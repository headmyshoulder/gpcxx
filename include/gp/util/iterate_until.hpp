...
#ifndef GP_UTIL_ITERATE_UNTIL_HPP_DEFINED
#define GP_UTIL_ITERATE_UNTIL_HPP_DEFINED
...
bool iterate_until( Seq const& s , F f )
{
    ...
    return gp::detail::iterate_until( boost::fusion::begin( s ) , boost::fusion::end( s ) , f );
}
...
#endif // GP_UTIL_ITERATE_UNTIL_HPP_DEFINED
