...
using basic_tree = detail::tree_base< detail::basic_node< T , detail::node_base< detail::descending_vector_node< typename Allocator::template rebind< void* >::other > > > , Allocator >;
