...
// #include <gpcxx/tree/detail/basic_cursor.hpp>
...
{
    typedef intrusive_tree< T , Allocator > self_type;
...
//     typedef detail::basic_node_cursor< node_type const >                    const_cursor;
    ...
    {
        typedef intrusive_tree< U, typename Allocator::template rebind<U>::other > other;
    };
